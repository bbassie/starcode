...
// brandPaths are the driver marks (see brand.templ) as sprite symbols:
// the Claude sunburst alone is 1.8 KB of path, once per thread row.
...
func buildSprite() {
	...
	for _, n := range []string{"brand-claude", "brand-codex"} {
